            ...
            cache.modify({
                fields: {
                    getTransactions(existingTransactionRefs = [], { readField }) {
                        const updatedTransactionRefs = existingTransactionRefs.filter((transactionRef) => readField('_id', transactionRef) !== deletedTransactionId);
                        updatedTransactionRefs.forEach((transactionRef) => {
                            cache.writeFragment({
